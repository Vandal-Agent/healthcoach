...
def select_exact_food(
    *,
    ...
    for food in foods:
        ...
        # Description precision must dominate USDA data-type
        # preference. Otherwise an unrelated SR Legacy item such as
        # "Croissants, apple" can outrank "Apple, raw" merely because
        # SR Legacy receives a larger source-quality bonus.
